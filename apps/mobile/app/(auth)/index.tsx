...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: '#141414', borderWidth: 1, borderColor: '#1E1E1E', borderRadius: 10, padding: 16, color: '#FFF', fontSize: 16, marginBottom: 12 },
  button: { backgroundColor: '#FFF', borderRadius: 10, padding: 16, alignItems: 'center', marginTop: 8 },
